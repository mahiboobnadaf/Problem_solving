...
function m(){
    var n = 500;
    console.log(n);         // prints 500; coz it is in function scope
}
m();

console.log(n)          // prints 50; coz it is global scope & any changes made in funciton scope does not change value in global scope
